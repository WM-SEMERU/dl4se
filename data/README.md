...
| Applying deep learning based automatic bug triager to industrial projects | Lee, et al. | [FSE](https://dl.acm.org/doi/10.1145/3106237.3117776) | 2017 |
| Are deep neural networks the best choice for modeling source code? | Hellendoorn, et al. | [FSE](https://dl.acm.org/doi/10.1145/3106237.3106290) | 2017 |
| Automatic Categorization with Deep Neural Network for Open-Source Java Projects | Nguyen, et al. | [ICSE](https://ieeexplore.ieee.org/document/7965290) | 2017 |
| Automatic feature learning for predicting vulnerable software components | Dam, et al. | [TSE](https://ieeexplore.ieee.org/document/8540022) | 2018 |
| Automatic Program Synthesis of Long Programs with a Learned Garbage Collector | Zohar, et al. | [NIPS](http://papers.neurips.cc/paper/7479-automatic-program-synthesis-of-long-programs-with-a-learned-garbage-collector.pdf) | 2018 |
| Automatic text input generation for mobile testing | Liu, et al. | [ICSE](https://ieeexplore.ieee.org/document/7985701) | 2017 |
| Automatically generating commit messages from diffs using neural machine translation | Jiang et al. | [ASE](https://dl-acm-org.proxy.wm.edu/citation.cfm?id=3155583) | 2017 |
| Automatically learning semantic features for defect prediction | Wang, et al. | [ICSE](https://www.cs.purdue.edu/homes/lintan/publications/deeplearn-icse16.pdf) | 2016 |
...
| Deep Representations for Software Engineering | White, et al. | [ICSE](https://ieeexplore.ieee.org/document/7203069) | 2015 |
...
| DRLGENCERT: Deep Learning-based Automated Testing of Certificate Verification in SSL/TLS Implementations | Chen, et al. | [ICSME](https://ieeexplore.ieee.org/document/8529836) | 2018 |
...
| DWEN: deep word embedding network for duplicate bug report detection in software repositories | Budhiraja, et al. | [ICSE](https://dl.acm.org/doi/10.1145/3183440.3195092) | 2018 |
